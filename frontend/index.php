...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
      <div class="row">
        <div class="img-center d-md-none d-md-block">
          <img src="../pic/Group 278.png" height="300px" />
        </div>
        <div class="col-md-6 col-12 center">
          <h1 class="tagline">Simple solutions for complex problems</h1>
        </div>
        <div class="col-6 img-right d-sm-block d-none">
          <img src="../pic/Group 278.png" height="500px" />
        </div>
      </div>
      <div class="row row-padding">
        <div class="img-center d-md-none d-md-block">
          <img src="../pic/eCommerce-mobilee-mockup 1.png" height="300px" />
        </div>

        <div class="col-6 img-center d-sm-block d-none">
          <img src="../pic/eCommerce-mobilee-mockup 1.png" height="500px" />
        </div>
        <div class="col-md-6 col-12 center">
          <h1 class="list">Types Of Blogs</h1>
      ...
      <div class="row row-padding">
        <h1>Our Blogs</h1>
        <div class="col-md-6 col-12 img-center">
          <img src="../pic/Rectangle.png" height="300px" width="100%" />
        </div>
        <div class="col-md-6 col-12 center">
          <h1 class="list">How to deal with subjective feedback from client</h1>
          <p class="">
    ...
    <footer class="mt-4">
      <div class="main-content">
        <div class="left box">
          <h2>About us</h2>
          <div class="content">
            <p>We are a community where all can share their blogs..</p>
            <div class="social">
        ...
        <div class="center box">
          ...
          <div class="content">
            <div class="place">
              ...
              <span class="text">Birendranagar</span>
            </div>
            <div class="phone">
